...
// // import React, { useState } from 'react';
// import { Plus, Minus, PackageCheck, Truck } from 'lucide-react';
// import { OrderType, OrderItem } from '../types';
// import { createOrder } from '../services/orderService';
// import { getTodayDate } from '../utils/helpers';
// import { supabase } from '../lib/supabase';
...
//       {error && (
//         <div className="bg-red-100 border-l-4 border-red-500 p-4 rounded-md text-sm text-red-800">
//           {error}
//         </div>
//       )}
...
//         {type === 'sale' ? (
//           <><Truck className="mr-2 text-blue-600" size={28} /> Record Sale</>
//         ) : (
//           <><PackageCheck className="mr-2 text-emerald-600" size={28} /> Record Purchase</>
//         )}
//       </div>
...
//             type="button"
//             onClick={handleAddItem}
//             className="flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg shadow"
//           >
//             <Plus size={16} className="mr-1" /> Add Item
//           </button>
//         </div>
...
//         {items.map((item) => (
//           <div key={item.id} className="grid grid-cols-12 gap-4 p-4 bg-gray-100 rounded-lg">
...
//               >
//                 <option value="kg">Kilograms</option>
//                 <option value="boxes">Tons</option>
//               </select>
//             </div>
...
//           type="submit"
//           disabled={isSubmitting}
//           className={`inline-flex items-center px-5 py-2.5 text-sm font-semibold rounded-lg shadow text-white ${
//             isSubmitting
//               ? 'bg-gray-400 cursor-not-allowed'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            value={date}
            onChange={(e) => setDate(e.target.value)}
className="mt-1 block w-full bg-gray-100 border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500"
            required
          />
        </div>
